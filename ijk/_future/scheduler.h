...
public:
     ...
     * It is nonsense that schedule callback and submit request are in different
     * threads. Do it like this: e.g.
     *
     * // In this_loop thread.
     *
     ...
     * &this_loop);
     */
    virtual void ScheduleAfter(std::chrono::milliseconds duration,

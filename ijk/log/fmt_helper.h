...
inline fmt::string_view to_string_view(
    const fmt::basic_memory_buffer<char, Buffer_Size> &buf) noexcept {
...
inline void append_string_view(
    fmt::string_view view, fmt::basic_memory_buffer<char, Buffer_Size> &dest) {
...
inline ToDuration time_fraction(const log_clock_t::time_point &tp) {

...
protected:
    ...
    std::map<server_addr, server_connection *> conns_;
};
...
public:
    ...
    void run_on_client_side(network_service_manager &manager,
                            const server_addr &target_addr) {
...
private:
    static bool encode(const SNMessage &msg, std::string &buf) {

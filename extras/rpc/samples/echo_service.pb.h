...
#include "ijkrpc_option.pb.h"  // IWYU pragma: export
...
class EchoRequest : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:ijk.test.EchoRequest) */ {
 public:
  EchoRequest();
  virtual ~EchoRequest();
...
class EchoResponse : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:ijk.test.EchoResponse) */ {
 public:
  EchoResponse();
